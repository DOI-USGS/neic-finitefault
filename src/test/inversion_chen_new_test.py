...
#             solucion = f.read()
#         with open(RESULTS_DIR / "NP1" / "Solucion.txt", "w") as fix:
#             fix.write(solucion)
...
#         with open(tempdir / "20150916225432" / "ffm.0" / "NP1" / "Solucion.txt") as f:
#             solucion = f.read()
#         with open(RESULTS_DIR / "NP1" / "Solucion_cgps.txt", "w") as fix:
#             fix.write(solucion)
...
#         with open(tempdir / "20150916225432" / "ffm.0" / "NP1" / "Solucion.txt") as f:
#             solucion = f.read()
#         with open(RESULTS_DIR / "NP1" / "Solucion_gps.txt", "w") as fix:
#             fix.write(solucion)
...
#         with open(tempdir / "20150916225432" / "ffm.0" / "NP1" / "Solucion.txt") as f:
#             solucion = f.read()
#         with open(RESULTS_DIR / "NP1" / "Solucion_insar.txt", "w") as fix:
#             fix.write(solucion)
...
#         with open(RESULTS_DIR / "NP1" / "Solucion_strong_motion.txt", "w") as fix:
#             fix.write(solucion)
...
#         with open(RESULTS_DIR / "NP1" / "Solucion_tele.txt", "w") as fix:
#             fix.write(solucion)
