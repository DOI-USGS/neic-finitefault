...
def test_get_data_dict():
    ...
    try:
        ...
        for wform, target_min, target_max, target_mean in zip(
            updated,
            [-27.4672451, -17.6785355, -157.930832],
            [4.59910393, 7.30249023, 1.07658386],
            [-8.75607520617732, -4.619506918795454, -111.42319765874645],
        ):
...
def test_retrieve_gps():
    ...
    try:
        ...
        np.testing.assert_array_equal(
            synthetic,
            [
                ["-0.352439940", "-1.93933582", "-4.41511869"],
                ["1.61021435", "0.400035709", "-10.0302095"],
                ["1.88719749", "-10.7268877", "-23.2681751"],
                ["-1.17435718", "-9.81808567", "-23.8910484"],
                ["-5.87845135", "-9.15926170", "-45.3398895"],
                ["-2.97966576", "4.53716516", "-38.8088074"],
                ["-2.90900588", "2.37702346", "-10.9237909"],
                ["-13.5752621", "-2.52334666", "-81.3168640"],
                ["-6.12933254", "8.49450111", "-39.5032196"],
                ["-23.2879772", "-24.1269703", "-144.573471"],
            ],
        )
        np.testing.assert_array_equal(
            error,
